...
const I18N = {
  en: {
    ...
    "wixcase.h3": "WixPort Pro Marketing Site",
    "wixcase.sub": "Commercial landing page for a Chrome extension with pricing and legal pages.",
    "wixcase.b1": "Clear product flow: Input → Transform → Output",
    "wixcase.b2": "Trust-focused pricing and strong purchase CTA",
    "wixcase.b3": "Fast responsive layout for desktop and mobile traffic",
    "wixcase.view": "View live site",
    "wixcase.repo": "View live site",
  ...
  it: {
    ...
    "wixcase.h3": "Sito Marketing WixPort Pro",
    "wixcase.sub": "Landing commerciale per estensione Chrome con pricing e pagine legali.",
    "wixcase.b1": "Flusso prodotto chiaro: Input → Trasformazione → Output",
    "wixcase.b2": "Pricing affidabile e CTA d'acquisto forte",
    "wixcase.b3": "Layout veloce e responsive per traffico desktop/mobile",
    "wixcase.view": "Apri il sito",
    "wixcase.repo": "Apri sito live",
